...
% directions of an olivine crystal determined by EBSD. 
...
odf = calcDensity(ebsd_smoothed('Forsterite').orientations);
...
ResultsFile = fullfile(pname, 'OlivineEBSD_Results.csv'); % Sets the save location to the folder where the EBSD data is located.
...
disp(['These results were added to the OlivineEBSD_results.csv file in ' (pname)]);
